...
class EstablishmentOperationBoundary(AbstractBoundary):
    ...
    def list_establishment_screen(self, dias_de_funcionamento,
                                  horarios_de_funcionamento):
        layout = [
            [sg.Text(
                'No momento, este é o atual Funcionamento do Estabelecimento.',
                font='Arial 14', pad=25)],
            [sg.Text("Dias de Funcionamento:", font='Arial 11',
                     size=EstablishmentOperationBoundary.TEXT_SIZE),
             sg.Listbox(values=dias_de_funcionamento,
                        select_mode='extended',
                        key="dias_de_funcionamento",
                        disabled=True,
                        size=(32, 7), pad=5)],
            [sg.Text("Abertura:", font='Arial 11',
                     size=EstablishmentOperationBoundary.TEXT_SIZE),
             ...
             sg.Text("min", size=15)],
            [sg.Text("Fechamento:", font='Arial 11',
                     size=EstablishmentOperationBoundary.TEXT_SIZE),
             sg.Spin([i for i in range(0, 24)], size=3, disabled=True,
             ...
             sg.Text("min", size=15)],
            [sg.Cancel('Voltar', key=EstablishmentOperationBoundary.CANCEL,
                       size=EstablishmentOperationBoundary.TEXT_SIZE, pad=20),
             sg.Cancel('Alterar', key=EstablishmentOperationBoundary.UPDATE,
                       size=EstablishmentOperationBoundary.TEXT_SIZE, pad=20)]
        ]

        window = sg.Window(
            'Flanelinha Veloz - Funcionamento do Estabelecimento',
            size=(900, 550),
    ...
    def menu_update_establishment_screen(self, dias_de_funcionamento,
                                         horarios_de_funcionamento):
        layout = [
            [sg.Text(
                'Altere o Funcionamento do Estabelecimento e confirme as alterações.',
                font='Arial 14', pad=25)],
            [sg.Text("Dias de Funcionamento:", font='Arial 11',
                     size=EstablishmentOperationBoundary.TEXT_SIZE),
            ...
            [sg.Text("Fechamento:", font='Arial 11',
             ...
             sg.Spin([i for i in range(0, 60, 30)], size=3,
                     ...
                     key="fechamento_estabelecimento_minuto"),
             sg.Text("min", size=15)],
            [sg.Cancel('Cancelar', key=EstablishmentOperationBoundary.CANCEL,
                       size=EstablishmentOperationBoundary.TEXT_SIZE, pad=20),
             sg.Submit('Confirmar', key=EstablishmentOperationBoundary.SUBMIT,
                       size=EstablishmentOperationBoundary.TEXT_SIZE, pad=20)]
        ]

        window = sg.Window(
            'Flanelinha Veloz - Alterando Funcionamento do Estabelecimento',
            size=(900, 550),
            element_justification='c',
            resizable=True,
            margins=(100, 100)) \
