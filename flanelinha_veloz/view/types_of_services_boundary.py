...
class TypesOfServicesBoundary(AbstractBoundary):
    ...
    def open_options(self):
        layout = [
            [sg.Button('Adicionar', key=1,
                       size=TypesOfServicesBoundary.TEXT_SIZE)],
            ...
            [sg.Button('Excluir', key=4,
                       size=TypesOfServicesBoundary.TEXT_SIZE)],
            [sg.Cancel('Voltar', key=TypesOfServicesBoundary.CANCEL,
                       size=TypesOfServicesBoundary.TEXT_SIZE)]
        ]
    ...
    def registration_types_of_services_screen(self):
        layout = [
            ...
            [sg.Text('Duração: * (hh:mm) ',
                     size=TypesOfServicesBoundary.TEXT_SIZE),
             sg.In(key='duracao', size=TypesOfServicesBoundary.INPUT_SIZE)],
            [sg.Cancel('Voltar', key=TypesOfServicesBoundary.CANCEL,
                       size=TypesOfServicesBoundary.TEXT_SIZE),
             sg.Submit('Cadastrar', key=TypesOfServicesBoundary.SUBMIT,
                       size=TypesOfServicesBoundary.TEXT_SIZE)]
        ]
    ...
    def menu_update_types_of_services_screen(self, types_of_services):
        ...
        column_rigth = [
            ...
            [sg.In(key='codigo', justification='c',
                   size=TypesOfServicesBoundary.TEXT_SIZE)],
            [sg.Submit('Atualizar', key=TypesOfServicesBoundary.UPDATE,
                       size=17)]
        ]

        layout = [
            [sg.Text('Qual o tipo de serviço você gostaria de alterar?',
                     font='Arial 16', pad=10)],
    ...
    def update_types_of_services_screen(self, types_of_services):
        ...
        layout = [
            [sg.Text('Nome: * ', size=TypesOfServicesBoundary.TEXT_SIZE),
             sg.In(default_text=types_of_services.nome, key='nome',
                   size=TypesOfServicesBoundary.INPUT_SIZE)],
            [sg.Text('Preço: * ', size=TypesOfServicesBoundary.TEXT_SIZE),
             sg.In(default_text=types_of_services.preco, key='preco',
                   size=TypesOfServicesBoundary.INPUT_SIZE)],
            [sg.Text('Duração: * (hh:mm) ',
                     size=TypesOfServicesBoundary.TEXT_SIZE),
             sg.In(default_text=duracao, key='duracao',
                   size=TypesOfServicesBoundary.INPUT_SIZE)],
            [sg.Cancel('Voltar', key=TypesOfServicesBoundary.CANCEL,
                       size=TypesOfServicesBoundary.TEXT_SIZE),
             sg.Submit('Cadastrar', key=TypesOfServicesBoundary.SUBMIT,
    ...
    def menu_delete_types_of_services_screen(self, types_of_services):
        ...
        layout = [
            [sg.Text('Qual o tipo de serviço você gostaria de deletar?',
                     font='Arial 16', pad=10)],
            [sg.Column(column_left, element_justification='c'),
             sg.Column([[sg.Text('', size=(2, 0))]]),
             sg.Column(column_rigth, element_justification='c', pad=10)],
